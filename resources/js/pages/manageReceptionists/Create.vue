...
<template>
    <AppLayout :breadcrumbs="breadcrumbs" title="Create Receptionist">
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            <form @submit.prevent="submit" class="space-y-6 max-w-md mx-auto">
                ...
                <div>
                    ...
                    <p v-if="form.errors.national_id" class="text-red-500 text-sm mt-1">{{ form.errors.national_id }}
                    </p>
                </div>
        ...
        <div>
            ...
            <InputError :message="form.errors.country" class="mt-2" />
                ...
                <div>
                    ...
                    <input type="file" @change="(e) => (form.avatar_img = e.target.files[0])"
                        class="input input-bordered w-full" name="avatar_img" />
